  ...
  return (
    <section className="py-8 border-b border-slate-100 last:border-0">
      <div className="flex gap-5 items-baseline mb-3">
        <span className="text-xs font-semibold text-slate-400 tabular-nums w-6 shrink-0 pt-0.5">
      ...
      <p className="text-[15px] sm:text-base text-slate-600 leading-relaxed pl-11">
        {body}
      </p>
    </section>
  );
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-slate-100 bg-slate-50">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 py-14 sm:py-20">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 tracking-tight leading-tight mb-5">
            {title}
          </h1>
          ...
          <p className="text-sm text-slate-400">
            Last Updated: <span className="text-slate-500 font-medium">{LAST_UPDATED}</span>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-8 py-10 sm:py-14">
        ...
        <div className="mt-14 pt-10 border-t border-slate-100">
          <p className="text-sm font-semibold text-slate-900 mb-5">Questions about this document?</p>
