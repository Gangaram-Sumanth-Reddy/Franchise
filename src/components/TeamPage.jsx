...
function TeamPage() {
  ...
  return (
    <main className="w-full py-10 lg:py-16">
      <section className="relative overflow-hidden bg-[#F6F9F4] py-20">
        ...
        <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between gap-8">
            <div>
              ...
              <h2 className="mt-4 text-5xl font-extrabold uppercase leading-tight tracking-tight text-[#2d1b7f] sm:text-6xl">
                Small team with
                <br />
                millions of ideas
              </h2>
      ...
      <section className="mx-auto w-full max-w-[1200px] px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid items-stretch gap-10 lg:grid-cols-2">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-extrabold uppercase leading-tight tracking-tight text-[#201646] sm:text-5xl">
              We have a kick-ass
              <br />
              team for you
            </h1>
            ...
            <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
              ...
              <div className="mt-5 flex items-center gap-3">
                ...
                />
                <div>
                  <p className="text-sm font-semibold text-[#201646]">Kimberly Mastrangelo</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {featureCards.map((item) => (
            <article key={item.title} className="rounded-2xl border border-slate-200 bg-white p-6">
              ...
              <h3 className="mt-4 text-2xl font-bold tracking-tight text-[#221B4B]">{item.title}</h3>
      ...
      <section className="mx-auto w-full max-w-[1200px] px-4 pb-20 sm:px-6 lg:px-8">
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-violet-600">Our Team</p>
          <h2 className="mt-3 text-4xl font-extrabold uppercase tracking-tight text-[#221B4B] sm:text-5xl">
            Let&apos;s meet our awesome team
          </h2>
        </div>
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {teamGridMembers.map((member) => (
            <article key={member.name} className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-3">
              <div className="overflow-hidden rounded-xl">
                <img src={member.image} alt={member.name} className="aspect-[4/5] w-full object-cover" loading="lazy" />
              </div>
              <div className="px-2 pb-2 pt-4">
                <p className="text-3xl font-semibold tracking-tight text-[#221B4B]">{member.name}</p>
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-700 transition duration-200 hover:-translate-y-0.5 hover:bg-slate-100"
                  >
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 fill-current">
        ...
        <div className="mt-10 overflow-hidden">
          <div className="animate-marquee-left flex w-max items-center gap-6 py-2">
            {cultureLoopImages.map((image, idx) => (
              <div key={`${image}-${idx}`} className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
